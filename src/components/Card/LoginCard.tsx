        ...
        <>
            <div className="w-96 flex flex-col overflow-hidden">
                ...
                <div className="p-5 w-full border rounded-b-lg bg-white">
                    ...
                    <label className="text-gray-500">กรุณาเข้าสู่ระบบด้วยชื่อผู้ใช้หรืออีเมลของคุณ</label>
                    <form action={formHandler} className="flex flex-col mt-5">
                        <div className="flex flex-col">
                            <label className="flex gap-1">ชื่อผู้ใช้หรืออีเมล<span className="text-red-500">*</span></label>
                        ...
                        <div className="flex flex-col mt-5">
                            ...
                            <div className="label text-end">
                                <Link href={"/forgot-password"} className="text-xs text-gray-500 mt-1">ลืมรหัสผ่าน</Link>
                            </div>
                        </div>
                    ...
                    <div className="text-center mt-1 text-gray-500 text-sm">
                        ยังไม่เคยใช้เรา? <Link href="/register" className="text-blue-500 font-bold hover:text-blue-700">[กดที่นี่]</Link>
                    </div>
                </div>
            </div>
        </>
